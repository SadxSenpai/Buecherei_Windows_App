namespace Bücherei_Windows_App
{
    partial class Item_add_UC
    {
        ...
        private void InitializeComponent()
        {
            ...
            panel1.Name = "panel1";
            panel1.Size = new Size(455, 857);
            panel1.TabIndex = 0;
            // 
            // item_name_tb
            // 
            item_name_tb.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold);
            item_name_tb.Location = new Point(200, 63);
            item_name_tb.Margin = new Padding(3, 4, 3, 4);
            item_name_tb.Name = "item_name_tb";
            item_name_tb.Size = new Size(236, 39);
            item_name_tb.TabIndex = 33;
            // 
            // item_note_tb
            // 
            item_note_tb.Location = new Point(200, 556);
            item_note_tb.Margin = new Padding(3, 4, 3, 4);
            item_note_tb.Multiline = true;
            item_note_tb.Name = "item_note_tb";
            item_note_tb.Size = new Size(237, 127);
            item_note_tb.TabIndex = 32;
            // 
            // item_type_tb
            // 
            item_type_tb.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold);
            item_type_tb.Location = new Point(201, 457);
            item_type_tb.Margin = new Padding(3, 4, 3, 4);
            item_type_tb.Name = "item_type_tb";
            item_type_tb.Size = new Size(236, 39);
            item_type_tb.TabIndex = 31;
            // 
            // item_id_tb
            // 
            item_id_tb.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold);
            item_id_tb.Location = new Point(201, 359);
            item_id_tb.Margin = new Padding(3, 4, 3, 4);
            item_id_tb.Name = "item_id_tb";
            item_id_tb.Size = new Size(236, 39);
            item_id_tb.TabIndex = 30;
            // 
            // item_origin_tb
            // 
            item_origin_tb.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold);
            item_origin_tb.Location = new Point(201, 260);
            item_origin_tb.Margin = new Padding(3, 4, 3, 4);
            item_origin_tb.Name = "item_origin_tb";
            item_origin_tb.Size = new Size(236, 39);
            item_origin_tb.TabIndex = 29;
            // 
            // item_count_tb
            // 
            item_count_tb.Font = new Font("Segoe UI", 14.25F, FontStyle.Bold);
            item_count_tb.Location = new Point(201, 161);
            item_count_tb.Margin = new Padding(3, 4, 3, 4);
            item_count_tb.Name = "item_count_tb";
            item_count_tb.Size = new Size(236, 39);
            ...
            // item_add_finish_btn
            // 
            item_add_finish_btn.Location = new Point(77, 776);
            item_add_finish_btn.Margin = new Padding(3, 4, 3, 4);
            item_add_finish_btn.Name = "item_add_finish_btn";
            item_add_finish_btn.Size = new Size(286, 56);
            ...
            exit_label.Location = new Point(427, 0);
